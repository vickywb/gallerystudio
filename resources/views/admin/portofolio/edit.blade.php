...
@section('title', 'Admin Dashboard - Edit Portofolio')
@section('content')

    <div class="container-xxl flex-grow-1 container-p-y">
      <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Forms /</span> Edit Portofolio</h4>
            ...
            <div class="card mb-4">
              ...
              <div class="card-body">
                  ...
                  <select id="defaultSelect" class="form-select" name="category_id">
                    ...
                    @foreach ($categories as $category)
                      <option value="{{ $category->id }}" 
                        @if (old('category') == $category->id | $category->id == $portofolio->category_id)
                          selected
                        @endif
                      >
                        {{ $category->title }}
                ...
                <div>
                  ...
                  <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="description" placeholder="Description..">{{ old('description', $portofolio->description) }}</textarea>
                </div>
              </div>
